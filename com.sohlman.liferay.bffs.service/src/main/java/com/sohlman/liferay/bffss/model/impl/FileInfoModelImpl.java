 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link FileInfoModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FileInfoImpl}.
 * </p>
 *
...
public class FileInfoModelImpl extends BaseModelImpl<FileInfo>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.sohlman.liferay.bffss.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.sohlman.liferay.bffss.model.FileInfo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.sohlman.liferay.bffss.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.sohlman.liferay.bffss.model.FileInfo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.sohlman.liferay.bffss.service.util.PropsUtil.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.sohlman.liferay.bffss.service.util.PropsUtil.get(
	...
	private static final ClassLoader _classLoader = FileInfo.class.getClassLoader();
