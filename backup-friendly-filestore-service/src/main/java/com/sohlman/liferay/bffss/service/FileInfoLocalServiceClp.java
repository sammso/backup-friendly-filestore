 ...
 * @generated
 */
public class FileInfoLocalServiceClp implements FileInfoLocalService {
    ...
    public com.sohlman.liferay.bffss.model.FileInfo addFileInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(fileInfo) });
        } catch (Throwable t) {
    ...
    public com.sohlman.liferay.bffss.model.FileInfo createFileInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { fileInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sohlman.liferay.bffss.model.FileInfo deleteFileInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { fileInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sohlman.liferay.bffss.model.FileInfo fetchFileInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { fileInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sohlman.liferay.bffss.model.FileInfo getFileInfo(long fileInfoId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { fileInfoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
