...
public interface FileInfoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.sohlman.liferay.bfdms.service.impl.FileInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the file info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FileInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
